...
// 다른 여행 데이터에서도 이 구조 그대로 복사해서 재사용 가능(공항/도심역 이름·이동수단만 교체).
const TRANSIT_INFO = {
  title: "✈️ 후쿠오카 공항 → 하카타역",
  methods: [
    {
      icon: "🚇",
      name: "지하철 (추천)",
      steps: [
        "국제선 → 무료 셔틀버스 → 국내선 이동 (약 10~15분)",
        "후쿠오카공항역(공항선) 탑승",
        "2정거장 후 하카타역 하차 (약 5분)",
      ],
      durationLabel: "총 소요시간",
      duration: "약 20~25분",
      fareLabel: "요금",
      fare: "260엔",
      payment: ["현금", "IC 교통카드 (SUGOCA·ICOCA·Suica 등)", "Visa 등 컨택리스 카드"],
    },
    {
      icon: "🚌",
      name: "직행버스",
      ...
      durationLabel: "소요시간",
      duration: "약 15~20분 (교통 상황에 따라 변동)",
      fareLabel: "요금",
      fare: "400엔",
      payment: ["현금", "IC 교통카드", "Visa 등 컨택리스 카드"],
    },
  ],
  recommend: [
    "빠르고 시간 정확: 🚇 지하철",
    "짐이 많거나 환승이 번거롭다면: 🚌 직행버스",
  ],
};
...
// (app.js의 loadExpenses/currentExpenses 참고). 아직 한 번도 CSV를 올리지 않았을 때만
// 여기 값이 그대로 쓰인다.
